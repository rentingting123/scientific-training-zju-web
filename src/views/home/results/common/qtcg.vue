<template>
    <div class="qtcg">
        <el-table border :data="datas" border style="width: 100%">
            ...
            <el-table-column prop="jianjie" label="简介" min-width="100"></el-table-column>
...
export default {
    ...
    methods:{
        getLists(){
            network.getQtcgList({id:this.$route.params.id}).then(res=>{
        ...
        del(row){
            this.$confirm('删除后无法恢复，请确认是否删除','提示',{
                ...
                network.delQtcg({id: row.id}).then(res=>{
