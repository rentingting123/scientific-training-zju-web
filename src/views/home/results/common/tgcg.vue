<template>
    <div class="tgcg">
        <el-table border :data="datas" border style="width: 100%">
            ...
            <el-table-column prop="tgmc" label="推广成果名称" min-width="100"></el-table-column>
            <el-table-column prop="yydw" label="应用单位" min-width="100"></el-table-column>
            <el-table-column prop="shxy" label="社会效益" min-width="100"></el-table-column>
...
export default {
    ...
    methods:{
        getLists(){
            network.getTgcgList({id:this.$route.params.id}).then(res=>{
        ...
        del(row){
            this.$confirm('删除后无法恢复，请确认是否删除','提示',{
                ...
                network.delTgcg({id: row.id}).then(res=>{
