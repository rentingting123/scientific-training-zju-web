 ...
 components:{
    ...
    api.xyList().then(res => {
      this.xyoptions = res.data
         ...
         if(this.$route.query.nf&&this.$route.query.xmejlb){
    ...
    methods:{
      ...
      jiansuo(){
        ...
        getList1(){
          ...
          this.$router.push({path:'/home/sc',query:{xmlb:this.formData.xmlb,nf:this.formData.nf,xmejlb:this.formData.xmejlb}})
